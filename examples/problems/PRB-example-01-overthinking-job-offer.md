...
id: PRB-20000101-01
type: problem
title: "EXAMPLE — Paralyzed deciding on a new job offer"
created: 2000-01-01
updated: 2000-01-01
status: open
...
actions:
  - {id: ACT-PRB-20000101-01-01, what: "List the 3 things I am actually afraid of", why: "Names the vague fear so it can be examined", when: 2000-01-02, difficulty: easy, expected_result: "Fear becomes concrete and smaller", status: not_started, updated: 2000-01-01}
...
KND-20260607-01 (Seneca — On groundless anxiety): "We suffer more often in imagination than in reality."

# What Is In My Control
Fully: gathering facts, naming fears, setting a deadline. Outside: how the role actually unfolds.

# Possible Solutions
1. Set a 48-hour decision deadline. 2. List concrete fears and test each. 3. Talk once with a trusted person, then decide.

# Recommended Action Plan
Tonight: write the 3 fears. Tomorrow: define criteria. Within 48h: decide.

# Immediate Next Action
Write the 3 fears, 10 minutes tonight.

# Tracking Note
Example problem (sentinel id PRB-20000101-01).
